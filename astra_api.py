...
# Naya Endpoint jo Audio File receive karega
...
async def ask_voice_endpoint(audio_file: UploadFile = File(...)):
    ...
    # 1. Upload hui audio file ko temporarily save karna
    temp_input_path = "temp_input.wav"
    with open(temp_input_path, "wb") as f:
        f.write(await audio_file.read())
        
    # 2. GROQ STT (Aawaz ko text mein badalna)
    ...
    # 3. GEMINI LLM (Sawaal ka jawab sochna with SMART RETRY)
